...
class AgendasControllerTest < ActionController::TestCase
  ...
  test "should create agenda" do
    assert_difference('Agenda.count') do
      post :create, agenda: { description: @agenda.description, due: @agenda.due, priority: @agenda.priority, solution: @agenda.solution, status: @agenda.status }
    end
  ...
  test "should update agenda" do
    patch :update, id: @agenda, agenda: { description: @agenda.description, due: @agenda.due, priority: @agenda.priority, solution: @agenda.solution, status: @agenda.status }
    assert_redirected_to agenda_path(assigns(:agenda))
  end
